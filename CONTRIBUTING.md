...
- Use the [Bug Report](https://github.com/dmwork-org/dmwork-web/issues/new?template=bug_report.yml) template
- Include steps to reproduce, expected vs actual behavior, and environment info
- Attach screenshots or logs when possible

### Requesting Features

- Use the [Feature Request](https://github.com/dmwork-org/dmwork-web/issues/new?template=feature_request.yml) template
...
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/dmwork-org/dmwork-web.git
   ```
4. **Create a branch from the latest upstream main**:
   ...
   ```
5. **Push to your fork** and open a PR against `dmwork-org/dmwork-web:main`
...
Open a [Discussion](https://github.com/dmwork-org/dmwork-web/discussions) for general questions.
