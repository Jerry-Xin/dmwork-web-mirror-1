...
vi.mock("@dmwork/base/src/Service/APIClient", () => {
    const mockAPIClient = {
        shared: {
            get: vi.fn(),
            post: vi.fn(),
...
import APIClient from "@dmwork/base/src/Service/APIClient"
import VoiceService from "@dmwork/base/src/Service/VoiceService"
